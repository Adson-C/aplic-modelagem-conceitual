...
import com.adson.aplimc.repositories.ItemPedidoRepository;
import com.adson.aplimc.repositories.PagamentoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Elentrônico");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "adsonconceicao442@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "adsonconcecao@yahoo.com.br", "80236115006", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("875265186", "745259871"));
		cli2.addPerfil(Perfil.ADMIN);
		
		Endereco e1 = new Endereco(null, "Rua flores", "300", "Apto 203", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avinida Floriano", "2106", null, "Centro", "37777012", cli2, c2);
		...
		Pedido ped1 = new Pedido(null, sdf.parse("30/08/2021 10:32"), cli1, e1);
		Pedido ped2 = new Pedido(null, sdf.parse("10/09/2021 19:35"), cli1, e2);
