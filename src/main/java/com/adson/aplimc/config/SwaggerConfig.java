package com.adson.aplimc.config;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.adson.aplimc.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Apli-Modelagem-Conceitual-Spring-Boot",
				"Esta API é utilizada no curso de Spring Boot do prof. Nelio Alves",
				"Versão 1.0",
				"https://www.udemy.com/terms",
				new Contact("Adson Santos", "udemy.com/user/nelio-alves", "adsonconcecao@yahoo.com.br"),
